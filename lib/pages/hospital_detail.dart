  ...
  Future<void> getFavorite() async {
    if (widget.hospital != null && Variables.memberId != null) {
      var res = await http.get(
          Variables.url + '/getFavoritesByHospital?hosId=' +
              widget.hospital.hOSID.toString() +
              '&memberId=' + Variables.memberId.toString(),
          headers: {
      ...
      if (res.statusCode == 200) {
        ...
        List<FavoritesModel> _favoritesList = decodeList.map((i) =>
  ...
  Future<void> addFavorites() async {
    if (Variables.memberId != null) {
      if (!isFavorite) {
        ...
        var res = await http.get(
            Variables.url + '/delFavorites?id=' + favID,
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'bearer ' + Variables.accessToken
            });
                                  ...
                                  Material(
                                    ...
                                    child: IconButton(
                                      icon: Image.asset(
                                          ...
                                          width: 24.0,
                                          height: 24.0,
                                          color: isFavorite == false ? Variables
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Center(
                                child: Text(widget.hospital.category,),
                              ),
                              Center(
                                child: Text(widget.hospital.adres,),
                              ),
                              SizedBox(
                                height: 10.0,
                              ),
                              widget.hospital.indirim > 0 ? Container(
                                width: 85.0,
                                height: 32.0,
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      widget.hospital.indirim.toStringAsFixed(
                                          0) +
                                          '%',
                                      style: TextStyle(
                                        color: Colors.white,
                              ...
                              ListTile(
                                ...
                                trailing: Image.asset(
                                  'assets/images/next.png', width: 20.0,
                                  height: 20.0,),
                                dense: true,
                                onTap: () {
                                  Navigator.of(context).push(
                              ...
                              ListTile(
                                leading: Image.asset(
                                  'assets/images/doctor_lead.png', width: 20.0,
                                  height: 20.0,),
                                title: Text(
                                  AppLocalizations.of(context).translate(
                                      'doctors'),
                              ...
                              ListTile(
                                leading: Image.asset(
                                  'assets/images/pin.png', width: 20.0,
                                  height: 20.0,),
                                title: Text(
                                  AppLocalizations.of(context).translate(
                                      'where'),
