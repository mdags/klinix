...
class _DoctorDetailPageState extends State<DoctorDetailPage> {
  ...
  List<DoctorsModel> doctorInfo = new List<DoctorsModel>();
  ...
  Future<void> getDocInfo() async {
    var res = await http.get(
        Variables.url + '/getDocInfo?docId=' + widget.doctor.dOCID.toString() +
            '&lang=' + Variables.lang +
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Center(
                                child: Text(widget.doctor.title,),
                              ),
                              SizedBox(
                                height: 10.0,
                              ),
                                        ...
                                        children: [
                                          Text(AppLocalizations.of(context)
                                            ...
                                            style: TextStyle(
                                                fontWeight: FontWeight.bold),),
                                          SizedBox(width: 5.0,),
                                          _hospital.sehir != null ? Text(
                                              _hospital.category + ' / ' +
                                                  _hospital.sehir) : Text(''),
                                        ]
                                    ),
                                    TableRow(
                                        children: [
